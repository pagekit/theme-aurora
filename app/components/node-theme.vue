<template>
    ...
    <div class="uk-form-horizontal">
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls uk-form-controls-text">
                <p class="uk-form-controls-condensed">
                   <select id="form-hero-style" class="uk-form-width-large" v-model="node.theme.sidebar_width">
               ...
               <p class="uk-form-help-block">{{ 'Select the sidebar width.' | trans }}</p>
                <p class="uk-form-controls-condensed">
                    <label><input type="checkbox" v-model="node.theme.sidebar_parallax"> {{ 'Enable parallax effect' | trans }}</label>
                </p>
                <p class="uk-form-controls-condensed uk-margin-bottom">
                    <label><input type="checkbox" v-model="node.theme.sidebar_fixed"> {{ 'Fixed background position' | trans }}</label>
                </p>
            </div>
        </div>
        ...
        <div class="uk-form-row">
            ...
            <div class="uk-form-controls uk-form-controls-text">
                <label><input type="checkbox" v-model="node.theme.section_divider"> {{ 'Displays a divider between the layout sections.' | trans }}</label>
            </div>
        </div>
        ...
        <div class="uk-form-row">
            <label for="form-content-top-style" class="uk-form-label">Content Top {{ 'Position' | trans }}</label>
            <div class="uk-form-controls">
                <select id="form-content-top-style" class="uk-form-width-large" v-model="node.theme.content_top_style">
                    <option value="uk-block-default">{{ 'Default' | trans }}</option>
                    <option value="uk-block-muted">{{ 'Muted' | trans }}</option>
        ...
        <div class="uk-form-row">
            <span class="uk-form-label">{{ 'Content Top Padding' | trans }}</span>
            <div class="uk-form-controls uk-form-controls-text">
                <label><input type="checkbox" v-model="node.theme.content_top_padding"> {{ 'Remove the padding (whitespace) from the layout position for rimless content display.' | trans }}</label>
            </div>
        </div>
        ...
        <div class="uk-form-row">
            <label for="form-content-bottom-style" class="uk-form-label">Content Bottom {{ 'Position' | trans }}</label>
            <div class="uk-form-controls">
                <select id="form-content-bottom-style" class="uk-form-width-large" v-model="node.theme.content_bottom_style">
                    <option value="uk-block-default">{{ 'Default' | trans }}</option>
                    <option value="uk-block-muted">{{ 'Muted' | trans }}</option>
                    <option value="uk-block-primary uk-contrast">{{ 'Primary' | trans }}</option>
                    <option value="uk-block-secondary uk-contrast">{{ 'Secondary' | trans }}</option>
        ...
        <div class="uk-form-row">
            <span class="uk-form-label">{{ 'Content Bottom Padding' | trans }}</span>
            <div class="uk-form-controls uk-form-controls-text">
                <label><input type="checkbox" v-model="node.theme.content_bottom_padding"> {{ 'Remove the padding (whitespace) from the layout position for rimless content display.' | trans }}</label>
            </div>
        </div>
